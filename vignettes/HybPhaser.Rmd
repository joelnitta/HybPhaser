...
After clade-association and phasing stats collation, the typical HybPhaser
workflow continues with:

1. **Merging** - Combine phased and non-phased sequences
...
- Function documentation: `?count_snps`, `?assess_dataset`,
  ...
  `?collate_phasing_stats`, `?collate_phasing_stats_from_config`
