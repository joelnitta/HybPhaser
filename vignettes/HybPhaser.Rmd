...
After generating merged sequence lists, the combined dataset is ready for
alignment and phylogenetic analyses.

Additional utility functions will continue to be added in future updates.
...
- Function documentation: `?count_snps`, `?assess_dataset`,
  ...
  `?merge_sequence_lists`, `?merge_sequence_lists_from_config`
